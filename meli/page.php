		...
		if ( have_posts() ) :
			...
			while ( have_posts() ) : the_post();
				...
				<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
					...
					<div class="breadcrumbs"><a href="<?php bloginfo('url')?>/cursos"><?php _e( 'Cursos', 'meli-centro-vendedores' ); ?></a> <i class="fa fa-angle-right"></i> <a href="<?php bloginfo('url')?>/cursos/?u=<?=$categorySlug?>"><?= $category;  ?> </a> <i class="fa fa-angle-right"></i> <?php the_title(); ?></div>
